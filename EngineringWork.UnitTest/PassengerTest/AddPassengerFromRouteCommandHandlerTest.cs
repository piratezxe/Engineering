...
{
    public class AddPassengerFromRouteCommandHandlerTest 
    {
        [Fact]
        public async Task add_passenger_to_route_handler_should_not_be_null()
        {
            ...
            var passengerHandler = new AddPassengerToRouteHandler(passengerRepositoryMock.Object, routeRepositoryMock.Object, nodeManagerMock.Object);
